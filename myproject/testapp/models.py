...
class InvoiceProduct(BaseModel):
    ...
    reduction_rate = models.DecimalField(max_digits=5, decimal_places=2, default=0.00, validators=[MinValueValidator(0.00), MaxValueValidator(100.00)])  # Reduction rate between 0% and 100%
    vat_rate = models.DecimalField(max_digits=5, decimal_places=2, default=20.00, choices=[
    (7.00, '7%'), (10.00, '10%'), (11.00, '11%'), (14.00, '14%'), (16.00, '16%'), (20.00, '20%')
])
