...
class StampRightDocumentUploadView(View):
    """View for uploading Stamp Rights declaration or payment documents"""
    def post(self, request, declaration_id):
        try:
            declaration = get_object_or_404(StampRightDeclaration, id=declaration_id)
...
class StampRightDocumentDeleteView(View):
    """View for deleting Stamp Rights declaration or payment documents"""
    def post(self, request, declaration_id):
        try:
            declaration = get_object_or_404(StampRightDeclaration, id=declaration_id)
